...
public class GrimPanModel {
	...
	public void setSaveFile(File saveFile) {
		...
		//mainFrame.setTitle("ï¿½×¸ï¿½ï¿½ï¿½ - "+saveFile.getPath());
	}
	/**
	 * @return the nPolygon
	 */
	...
	public void getSelectedShape_del(){ //¸¶¿ì½º°¡ À§Ä¡ÇÑ µµÇüÀÇ ÀÎµ¦½º¸¦ set
		int selIndex = -1;
		Shape shape = null;
		for (int i=this.shapeList.size()-1; i >= 0; --i){
			shape = this.shapeList.get(i).getShape();
	...
	public void deleteShapeAction() { //delete actionÀ» ÇÏ´Â ÇÔ¼ö 
		//delcommand¸¦ ½ºÅÃ¿¡ ³Ö¾îÁÖ°í, executeÇÔ¼ö ½ÇÇà
